...
const ENDPOINTS = [
  ...
  endpoint({ key: "users.search", group: "users", method: "GET", path: "/users/search", description: "Search users/team members.", requiredScopes: ["users.readonly"] }),
  endpoint({ key: "users.location.list", group: "users", method: "GET", path: "/locations/:locationId/users", description: "List location users.", requiredScopes: ["users.readonly"], requiresLocationId: false }),
