...
const SMS_SETTINGS = {
  ...
  INBOUND_INFO_REPLY: {
    trigger: "Somebody texts 631-888-6340 something that is not STOP, START or HELP.",
    event: "routes/smsWebhook.js -> replyThatNobodyIsReading",
    appliesTo:
      "Whoever sent the message, account or not - the consent basis is their own inbound text",
    schedule:
      "Immediately, and at most once per number per New York day. The dedupe key is what " +
      "stops two automated systems answering each other forever.",
    notes:
      "Never sent to a number under a STOP, never sent to our own number, and never sent in " +
